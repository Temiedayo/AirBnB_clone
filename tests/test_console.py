...
class TestHBNBCommand_destroy(unittest.TestCase):
    """unittests 4 testing destroy from HBNB command interpreter."""
...
class TestHBNBCommand_all(unittest.TestCase):
    """unittests 4 testing all of HBNB command interpreter."""
...
class TestHBNBCommand_update(unittest.TestCase):
    """unittests 4 testing update from HBNB command interpreter."""
...
class TestHBNBCommand_count(unittest.TestCase):
    """unittests for testing the count method of HBNB comand interpreter."""
